...
const ProductDetail = ({ product }: ProductDetailProps) => {const [currentImage, setCurrentImage] = useState(0);
    ...
    return (
        ...
        <nav className="mb-8">
            ...
            <li>/</li>
            <li><a href="/category" className="hover:text-gray-900">Category</a></li>
            <li>/</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex items-center space-x-2">
                <div className="flex">
                {[1, 2, 3, 4].map((n) => (
                    <Star key={n} className="h-5 w-5 fill-current text-yellow-400" />
                ))}
